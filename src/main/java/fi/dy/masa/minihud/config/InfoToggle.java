...
public enum InfoToggle implements IConfigInteger, IHotkeyTogglable
{
    ...
    BLOCK_IN_CHUNK          ("infoBlockInChunk",            false, 29, "", "Show the player's current position within the Chunk"),
    BLOCK_POS               ("infoBlockPosition",           false,  6, "", "Show the player's current block position"),
    BLOCK_PROPS             ("infoBlockProperties",         false, 28, "", "Show the BlockState properties and values"),
    CHUNK_POS               ("infoChunkPosition",           false,  7, "", "Show the Chunk the player is currently within"),
    CHUNK_SECTIONS          ("infoChunkSections",           false, 15, "", "Show the currently rendered number of\nChunk sections (the C value from F3)"),
    CHUNK_SECTIONS_FULL     ("infoChunkSectionsLine",       false, 16, "", "Show the entire line of the C value from the F3 screen"),
    CHUNK_UPDATES           ("infoChunkUpdates",            false, 17, "", "Show the current number of chunk updates per second"),
    ...
    DIFFICULTY              ("infoDifficulty",              false, 19, "", "Show the local difficulty"),
    ...
    //ENTITIES                ("infoEntities",                false, 22, "", "Show the visible/loaded entity count"),
    ENTITIES_CLIENT   ("infoEntitiesClient",                false, 22, "", "Show the visible/loaded entity count"),
    ENTITIES_SERVER   ("infoEntitiesServer",                false, 22, "", "Show the entity count in the world list/map"),
    ENTITY_REG_NAME         ("infoEntityRegistryName",      false, 25, "", "Show the registry name of the entity\nthe player is currently looking at"),
    ...
    LIGHT_LEVEL_CLIENT      ("infoLightLevelClient",        false, 10, "", "Show the current client light level"),
    LIGHT_LEVEL_SERVER      ("infoLightLevelServer",        false, 11, "", "Show the current server light level"),
    LOOKING_AT_BLOCK        ("infoLookingAtBlock",          false, 26, "", "Show which block the player is currently looking at"),
    LOOKING_AT_BLOCK_CHUNK  ("infoLookingAtBlockInChunk",   false, 27, "", "Show which block within its containing chunk\nthe player is currently looking at"),
    LOOKING_AT_ENTITY       ("infoLookingAtEntity",         false, 24, "", "Show the entity name and health when looked at"),
    ...
    PARTICLE_COUNT          ("infoParticleCount",           false, 18, "", "Show the currently renderer particle count (P from F3)"),
    PING                    ("infoPing",                    false, 36, "", "Show the current ping to the server"),
    REGION_FILE             ("infoRegionFile",              false, 30, "", "Show the region file the player is currently within"),
    ROTATION_PITCH          ("infoRotationPitch",           false, 13, "", "Show the player's pitch rotation"),
    ROTATION_YAW            ("infoRotationYaw",             false, 12, "", "Show the player's yaw rotation"),
    ...
    SPEED                   ("infoSpeed",                   false, 14, "", "Show the player's current moving speed"),
    SPEED_AXIS              ("infoSpeedAxis",               false, 14, "", "Show the player's current moving speed per axis"),
    SPEED_HV                ("infoSpeedHV",                 false, 14, "", "Show the player's current moving speed both horizontally and vertically."),
